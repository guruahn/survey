    ...
    if(this.state.popoverState){
      popover = <div className="header-popover js-header-popover u-zIndexTop">
        <div className="header-popover__inner">
          <ul className="">
            <li className="header-menu"><Link to="/mySurveys" >My Surveys</Link></li>
            <li className="header-menu">
              <Link
                to="#"
                className={this.props.auth ? '' : 'u-displayNone'}
                onClick={this.props.onLogout}>
                Logout
              </Link>
            </li>
            <li className="header-menu"><Link to="/login" className={this.props.auth ? 'u-displayNone' : ''} >Login</Link></li>
